...
/**
  ...
  * @brief          : STM32-based flappy bird clone using DotMatrix
  ******************************************************************************
  * @attention
  *
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, R2_Pin|R3_Pin|R4_Pin|R5_Pin
                          |R6_Pin|R7_Pin|R0_Pin|R1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, C0_Pin|C1_Pin|C2_Pin|C3_Pin
